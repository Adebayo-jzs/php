...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.hugeicons.com/font/free/all.min.css">
...
<body>
    <div class="container corner-border">
        ...
        <header class="header-section">
            <i class="hugeicons-database-02"></i>
            ...
            <section>
                ...
                <div class="dashboard-grid">
                    <div class="card corner-border">
                        <div class="inner"></div>
                        <?php
                        $sourceIcon = "hugeicons-zap";
                        if ($currentSource == "Solar Power")
                            $sourceIcon = "hugeicons-sun-01";
                        if ($currentSource == "Inverter Battery")
                            $sourceIcon = "hugeicons-battery-charging-01";
                        if (strpos($currentSource, "Low Battery") !== false)
                            $sourceIcon = "hugeicons-battery-low";
                        ?>
                        <i class="<?php echo $sourceIcon; ?> huge-icon"></i>
                    ...
                    <div class="card corner-border">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <div class="status-badge <?php echo $isCharging || $batteryLevel == 100  ? 'status-success' : 'status-danger'; ?>">
